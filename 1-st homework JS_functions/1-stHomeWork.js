...
//   let CharArray = word.charAt(index-1);
//   if (CharArray === char) {
...
let checkLenght = function(str, expectedLength) {
  if (str.lenght == expectedLength-1) {
    alert('Вірно, вгадав');
    return true;
  } else {
    alert('Не вгадав');
...
checkLenght (prompt("Введіть будь яку комбінацію символів"), +prompt("Вгадайте скільки символів ви ввели у попередньому рядку!?"))
