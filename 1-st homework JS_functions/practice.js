...
wareCondom(user) //виклик функції wareCondom аргументом в яку переходить user (у данному випадку юсер-це об'єкт який сформовано у рядку №15 (було додано зе одні властивість))
//===============
let x, y, z
x = 6
--x
